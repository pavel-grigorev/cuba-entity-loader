...
public class CubaentityloaderTestContainer extends TestContainer {

    public CubaentityloaderTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "org/thepavel/cubaentityloader/app.properties",
    ...
    public static class Common extends CubaentityloaderTestContainer {

        public static final CubaentityloaderTestContainer.Common INSTANCE = new CubaentityloaderTestContainer.Common();
